...
export default function SpinWheel({
  ...
  // Draw wheel — redraws whenever customers or rotation changes
  useEffect(() => {
    ...
    customers.forEach((customer, i) => {
      ...
      // Only draw text if segment is large enough (>=3°)
      if (segmentAngle >= 3) {
