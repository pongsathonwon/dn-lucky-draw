...
export default function SlotMachine({
  ...
  // Build circular display: prev, current, next
  const getThree = (arr, idx) => {
  ...
  useEffect(() => {
    ...
    const spin = () => {
      ...
      // Gradually slow down in last 30%
      if (progress > 0.7) {
  ...
  const [prevName, currName, nextName] =
    displayItems.length === 3 ? displayItems : ["", "", ""];
